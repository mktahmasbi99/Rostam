...
export function SettingsPage({ config }: { config: Config }) {
  ...
  return <main className="page settings-page">
    ...
    <section className="settings-card">
      <h2>Install Rostam</h2>
      <p>Add Rostam to your home screen to open it as an app.</p>
      <p><strong>Android:</strong> Open Rostam in Chrome, then choose Install app or Add to Home screen from the browser menu.</p>
      <p><strong>iPhone or iPad:</strong> Open Rostam in Safari, tap Share, then Add to Home Screen. Keep Open as Web App enabled if shown, then tap Add.</p>
      <p>Use your secure HTTPS server address. A connection to your server is needed to load and save your ledger.</p>
    </section>
